...
#ifndef PUPPER_INTERFACES__SRV__DETAIL__PLAY_MUSIC__FUNCTIONS_H_
#define PUPPER_INTERFACES__SRV__DETAIL__PLAY_MUSIC__FUNCTIONS_H_
...
/// Initialize srv/PlayMusic message.
/**
...
/// Finalize srv/PlayMusic message.
/**
...
/// Create srv/PlayMusic message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pupper_interfaces__srv__PlayMusic_Request__init().
...
/// Destroy srv/PlayMusic message.
/**
 * It calls
 * pupper_interfaces__srv__PlayMusic_Request__fini()
...
/// Check for srv/PlayMusic message equality.
/**
...
/// Initialize array of srv/PlayMusic messages.
/**
...
/// Finalize array of srv/PlayMusic messages.
/**
 * It calls
 * pupper_interfaces__srv__PlayMusic_Request__fini()
...
/// Create array of srv/PlayMusic messages.
/**
 * It allocates the memory for the array and calls
 * pupper_interfaces__srv__PlayMusic_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PlayMusic messages.
/**
 * It calls
 * pupper_interfaces__srv__PlayMusic_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PlayMusic message array equality.
/**
...
/// Copy an array of srv/PlayMusic messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pupper_interfaces__srv__PlayMusic_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pupper_interfaces
...
/**
 * It calls
 * pupper_interfaces__srv__PlayMusic_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_pupper_interfaces
...
/**
 * It allocates the memory for the array and calls
 * pupper_interfaces__srv__PlayMusic_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pupper_interfaces
...
/**
 * It calls
 * pupper_interfaces__srv__PlayMusic_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PUPPER_INTERFACES__SRV__DETAIL__PLAY_MUSIC__FUNCTIONS_H_
