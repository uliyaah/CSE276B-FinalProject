...
static const _PlayMusic_Request_type_support_symbol_names_t _PlayMusic_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pupper_interfaces, srv, PlayMusic_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pupper_interfaces, srv, PlayMusic_Request)),
  }
};
...
{
  return &::pupper_interfaces::srv::rosidl_typesupport_cpp::PlayMusic_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pupper_interfaces, srv, PlayMusic_Request)() {
  return get_message_type_support_handle<pupper_interfaces::srv::PlayMusic_Request>();
}
...
static const _PlayMusic_Response_type_support_symbol_names_t _PlayMusic_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pupper_interfaces, srv, PlayMusic_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pupper_interfaces, srv, PlayMusic_Response)),
  }
};
...
{
  return &::pupper_interfaces::srv::rosidl_typesupport_cpp::PlayMusic_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pupper_interfaces, srv, PlayMusic_Response)() {
  return get_message_type_support_handle<pupper_interfaces::srv::PlayMusic_Response>();
}
...
static const _PlayMusic_type_support_symbol_names_t _PlayMusic_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pupper_interfaces, srv, PlayMusic)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pupper_interfaces, srv, PlayMusic)),
  }
};
...
{
  return &::pupper_interfaces::srv::rosidl_typesupport_cpp::PlayMusic_service_type_support_handle;
}
