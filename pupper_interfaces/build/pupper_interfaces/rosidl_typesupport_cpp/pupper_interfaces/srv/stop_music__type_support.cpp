...
static const _StopMusic_Request_type_support_symbol_names_t _StopMusic_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pupper_interfaces, srv, StopMusic_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pupper_interfaces, srv, StopMusic_Request)),
  }
};
...
{
  return &::pupper_interfaces::srv::rosidl_typesupport_cpp::StopMusic_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pupper_interfaces, srv, StopMusic_Request)() {
  return get_message_type_support_handle<pupper_interfaces::srv::StopMusic_Request>();
}
...
static const _StopMusic_Response_type_support_symbol_names_t _StopMusic_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pupper_interfaces, srv, StopMusic_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pupper_interfaces, srv, StopMusic_Response)),
  }
};
...
{
  return &::pupper_interfaces::srv::rosidl_typesupport_cpp::StopMusic_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pupper_interfaces, srv, StopMusic_Response)() {
  return get_message_type_support_handle<pupper_interfaces::srv::StopMusic_Response>();
}
...
static const _StopMusic_type_support_symbol_names_t _StopMusic_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pupper_interfaces, srv, StopMusic)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pupper_interfaces, srv, StopMusic)),
  }
};
...
{
  return &::pupper_interfaces::srv::rosidl_typesupport_cpp::StopMusic_service_type_support_handle;
}
