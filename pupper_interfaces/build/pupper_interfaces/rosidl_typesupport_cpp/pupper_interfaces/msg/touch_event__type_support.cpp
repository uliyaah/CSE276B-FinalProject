...
static const _TouchEvent_type_support_symbol_names_t _TouchEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pupper_interfaces, msg, TouchEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pupper_interfaces, msg, TouchEvent)),
  }
};
...
{
  return &::pupper_interfaces::msg::rosidl_typesupport_cpp::TouchEvent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pupper_interfaces, msg, TouchEvent)() {
  return get_message_type_support_handle<pupper_interfaces::msg::TouchEvent>();
}
