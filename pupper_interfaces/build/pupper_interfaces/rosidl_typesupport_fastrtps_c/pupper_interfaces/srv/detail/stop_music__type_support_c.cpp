...
#include "pupper_interfaces/srv/detail/stop_music__rosidl_typesupport_fastrtps_c.h"
...
using _StopMusic_Request__ros_msg_type = pupper_interfaces__srv__StopMusic_Request;
...
size_t get_serialized_size_pupper_interfaces__srv__StopMusic_Request(
  const void * untyped_ros_message,
...
static uint32_t _StopMusic_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pupper_interfaces__srv__StopMusic_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pupper_interfaces
size_t max_serialized_size_pupper_interfaces__srv__StopMusic_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pupper_interfaces__srv__StopMusic_Request;
    is_plain =
      (
...
static size_t _StopMusic_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pupper_interfaces__srv__StopMusic_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pupper_interfaces, srv, StopMusic_Request)() {
...
using _StopMusic_Response__ros_msg_type = pupper_interfaces__srv__StopMusic_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pupper_interfaces
size_t get_serialized_size_pupper_interfaces__srv__StopMusic_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StopMusic_Response__ros_msg_type * ros_message = static_cast<const _StopMusic_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_pupper_interfaces__srv__StopMusic_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pupper_interfaces
size_t max_serialized_size_pupper_interfaces__srv__StopMusic_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pupper_interfaces__srv__StopMusic_Response;
    is_plain =
      (
...
static size_t _StopMusic_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pupper_interfaces__srv__StopMusic_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pupper_interfaces, srv, StopMusic_Response)() {
...
// already included above
// #include "pupper_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "pupper_interfaces/srv/stop_music.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pupper_interfaces, srv, StopMusic)() {
